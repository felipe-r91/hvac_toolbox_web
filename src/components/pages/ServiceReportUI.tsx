...
function AlarmCard({
  ...
  return (
    <li className="group flex gap-3 bg-amber-50 p-2.5 text-sm text-amber-950 ring-1 ring-amber-100">
      ...
      {solved && (
        <span className="shrink-0 border border-emerald-300 bg-emerald-50 px-2 py-1 text-[10px] font-bold uppercase tracking-wide text-emerald-700">
          Solved
        </span>
      )}
      ...
      <div className="border-t border-slate-300 bg-white px-4 py-3">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <StatusPill
              tone={getStatusTone(report.serviceResult)}
              isPrintPreview={isPrintPreview}
              preservePrintStyle
            >
